...
C
   50 IF( abs(DX(I)) .lt. 1.e-37) GO TO 200
...
c      real function r1mach(j)
c      integer j
c      if(j.eq.1) then
c         r1mach=0.1175494E-37
c      elseif(j.eq.2) then
c         r1mach=0.3402823E+39
c      elseif(j.eq.3) then
c         r1mach=0.5960464E-07
c      elseif(j.eq.4) then
c         r1mach=0.1192093E-06
c      elseif(j.eq.5) then
c         r1mach=0.3010300
c      else
c         stop ' R1MATH input out of range'
c      endif
c      return
c      end
