...
c
c-----------------------------------------------------------------------
c subroutine:  r2tr		 radix 2 iteration subroutine
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
	subroutine r8trk (int, nn, br0, br1, br2, br3, br4, br5, br6,
     ...
     &    bi3(*), bi4(*), bi5(*), bi6(*), bi7(*)
        ...
        integer*4 l(22), l1, l2, l3, l4, l5, l6, l7, l8, l9, l10,
     &    l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21, l22

        integer*4 j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, 
     &    j13, j14, j15, j16, j17, j18, j19, j20, j21, jthet, k, ji, jr, 
     &    jl, k0, kl, int8, jlast, j, j0, th2
	...
	equivalence (l22,l(1)), (l21,l(2)), (l20,l(3)), (l19,l(4)),
     &    (l18,l(5)), (l17,l(6)), (l16,l(7)), (l15,l(8)), (l14,l(9)),
     &    (l13,l(10)), (l12,l(11)), (l11,l(12)), (l10,l(13)),
     &    (l9,l(14)), (l8,l(15)), (l7,l(16)), (l6,l(17)), (l5,l(18)),
...
c-----------------------------------------------------------------------
	subroutine ord2k (m, b)
     ...
     &    l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21, l22
        ...
        integer*4 j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12,
     &    j13, j14, j15, j16, j17, j18, j19, j20, j21, n, k, ji, ij
...
c real array discussed above.
	...
	do i=1,22
	  ...
	  write (*,*) ' nfft not a power of 2 < 22 for ffsk'
	  return
