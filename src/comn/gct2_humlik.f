      SUBROUTINE GCT2_HUMLIK ( N, X1, DX, Y, sublor, K )
...
c      REAL    X(0:N-1)                               ! IN   Input x array
      REAL*8  X1, DX    
      REAL    Y,XX                                    ! IN   Input y value >=0.0
...
* Constants
      ...
      SAVE  C, S, T    ! preserves values of C, S and T arrays between calls
* Local variables
      INTEGER I, J                                   ! Loop variables
      INTEGER RG1, RG2, RG3                          ! y polynomial flags
      REAL ABX, XQ, YQ, YRRTPI, sublor, S2           ! |x|, x^2, y^2, y/SQRT(pi)
