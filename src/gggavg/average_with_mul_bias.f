...
c  1)  For large values of ww, iteration converges very slowly.
      ...
      implicit none
      integer*4 lunr,mrow,nrow,irow,mcol,ncol,jcol,mit,jit,
...
c      write(*,*)jit,twas,tew
      if( tew .ge. twas ) return  ! fit failed to improve
      twas=tew
      end do  !  jit=1,mit
      write(*,*)'average_with_mul_bias failed to converge',twas,tew
      return
      end
