c  Program bin2asc.f
c  Converts an old format runlog to the new format.
c
      implicit none
      integer*4
...
c
      ...
      open(lunw,file='tcrlf.out',status='unknown')
      write(lunw,*)4,2
      write(lunw,'(a)') 'crlf'
      write(lunw,'(a)')
...
c  Read input runlog
1        call old_read_runlog (lunr,col1,specname,iyr,iset,zpdtim,
...
c  Write new runlog
     ...
     &   oblon,obalt,asza,zenoff,azim,osds,opd,fovi,fovo,amal,ifirst,
     &   ilast,
     ...
     &   pout,hout,fvsi,wspd,wdir,lasf,wavtkr,aipl,istat)         
      ...
      include '/home/toon/ggg/src/comn/write_runlog.f'
      include '/home/toon/ggg/src/comn/wlimit.f'
      include '/home/toon/ggg/src/comn/lnbc.f'

      subroutine old_read_runlog(lun,col1,runlab,iyr,iset,zpdtim,
     & oblat,oblon,obalt,asza,zenoff,opd,fovi,fovo,amal,ifirst,
     & ilast,graw,possp,bytepw,zoff,snr,apf,tins,pins,hins,
     & tout,pout,hout,lasf,wavtkr,sia,sis,aipl,istat)
c
