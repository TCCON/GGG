...
c       sort -k 1.3,1.10 -k 1.18 temp_file > db20051018.gop
c
c  The .gop file is intended to reside in the local directory,
...
c
      ...
      write(6,*)'SUNRUN     Version 1.2.0    30-Apr-2006    GCT'
