...
c
      write(6,*)'create_sunrun     Version 1.1.1    04-Apr-2008    GCT'
      col1=' '
c
...
c set tcorr once parsed filename (as file-dependent) 
      tcorr=(6*3600.0d0) ! 12 hours behind of UT
      oblat=80.050d0
      oblon=-86.420d0
      obalt=0.610d0
      tins=25.0d0
...
c  Remove any leading spaces/blanks.
         ...
         if (specname(1:1) .eq. 'e') fsf=1.000000d0 ! 120HR
         if(specname(16:16).eq.'a' ) then   ! InGaAs det.
            nus=4000.0d0
            nue=8500.0d0
         elseif(specname(16:16).eq.'b') then   ! Si det.
            nus=12950.0d0
            nue=14800.0d0
