...
two:
  ...
  readf,unit,format='(2f12.6,i6,3f8.3,f6.2,f7.3,1x,i3,f4.1,1x,i3)',$
...
;
  ...
  string(format='("  !7r!6!drms!n=",(f5.2),"%")',rms)+$
...
;  Write gas names to right of main panel.
  ...
  for i=0, ntgas-1 do begin
     if mtxt(i) eq 0 then begin
        xtxt(i)=xmax-0.28
        ytxt(i)=ymax-(i+0.5)*(ymax-ymin)/9 -0.15
...
;
  ...
  pplot_hno4,datarray,ntgas,npoints,nbox,rmax,tgas,xtxt,ytxt,text,ntgas+2+ntxt
;
