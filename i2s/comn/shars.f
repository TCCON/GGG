...
c  KMODE= +/- 1 cases, the unshifted points are simply skipped.
...
c  operator size). But the KMODE=+/-1 methods only requires half
c  the points be re-sampled and so is faster.
c
